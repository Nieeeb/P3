...
from data.Flare7K.data_loader_loc import Flare_Image_Loader
...
class LolDatasetLoader():
    def __init__(self, flare=bool, light_source_on_target=bool):
        ...
        self.flare = flare
        self.root = r'src\data\lol_dataset\our485'
    ...
    def __getitem__(self, idx):
        ...
        if self.flare and self.light_source_on_target:
            ...
            input_flare_image_loader.load_scattering_flare('Flare7K',r"C:\Users\Victor Steinrud\Documents\DAKI\3. semester\P3\data\Flare7K\Scattering_Flare\Light_Source")
            input_flare_image_loader.load_reflective_flare('Flare7K',r"C:\Users\Victor Steinrud\Documents\DAKI\3. semester\P3\data\Flare7K\Reflective_Flare")
            ...
            target_flare_image_loader.load_scattering_flare('Flare7K',r"C:\Users\Victor Steinrud\Documents\DAKI\3. semester\P3\data\Flare7K\Scattering_Flare\Light_Source")
        ...
        if self.flare and not self.light_source_on_target:
            ...
            flare_image_loader.load_scattering_flare('Flare7K',r"C:\Users\Victor Steinrud\Documents\DAKI\3. semester\P3\data\Flare7K\Scattering_Flare\Light_Source")
            flare_image_loader.load_reflective_flare('Flare7K',r"C:\Users\Victor Steinrud\Documents\DAKI\3. semester\P3\data\Flare7K\Reflective_Flare")
